...
export default function TeamEliminationOverlay({
  ...
  return (
    <div
      className={
        embedded
          ? "flex min-h-[55vh] items-center justify-center py-6"
          : "fixed inset-0 z-[200] flex items-center justify-center bg-slate-950/65 p-4 backdrop-blur-sm"
      }
    >
      <section className="w-full max-w-xl overflow-hidden rounded-2xl border border-orange-100 bg-white shadow-xl shadow-slate-950/10">
