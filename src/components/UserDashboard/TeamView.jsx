      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        {stats.map(s => (
          <div key={s.label} className="rounded-xl p-4 text-center transition-all duration-200"
            style={{ background: '#FFFFFF', border: '1px solid #E5E7EB', boxShadow: '0 4px 12px rgba(0,0,0,0.01)' }}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
        ...
        <div className="lg:col-span-2 space-y-3">
          <div className="rounded-2xl p-5"
            ...
            <h3 className="text-sm font-bold text-[#111827] mb-4">Team Actions</h3>
            <div className="space-y-2.5">
              {[
                ...
                <button key={label}
                  className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-semibold text-[#374151] transition-all duration-200"
          ...
          <div className="rounded-2xl p-5"
            style={{ background: '#FFFFFF', border: '1px solid #E5E7EB', boxShadow: '0 10px 30px rgba(0,0,0,0.02)' }}>
            <h3 className="text-sm font-bold text-[#111827] mb-4">Sprint Progress</h3>
            {[
