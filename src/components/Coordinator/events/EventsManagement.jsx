    ...
    <div className="space-y-6">
      ...
      >
        <div className="grid gap-3 md:grid-cols-3">
          ...
          <select className="rounded-xl border border-slate-200 px-3 py-2.5 text-sm text-slate-600">
      ...
      {modal === "delete" && (
        ...
        >
          <p className="text-sm text-slate-600">
            This event will be hidden from active management but retained for
            audit history.
          </p>
        </ModalShell>
      )}
